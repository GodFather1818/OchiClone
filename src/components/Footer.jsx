...
function Footer() {
  return (
    <div  data-scroll data0scroll-speed="-.6" className='w-full h-screen bg-[#F1F1F1] flex px-32 pb-10' >
      <div className='w-1/2 mt-[1.5vw] h-full flex flex-col justify-between' >
        <div className="heading">
        <h1 className='font-TAJ text-[5.5vw] uppercase font-semibold leading-none'>Eye- </h1>
        <h1 className='font-TAJ text-[5.5vw] uppercase font-semibold leading-none'>Opening</h1>
        </div>
      ...
      <div className='w-1/2 mt-[1.5vw]' >
      <h1 className='font-TAJ text-[5.5vw] uppercase font-semibold'>Presentations</h1>
      <div className='dets' >
        <p className='block text-[2vw]'>S: </p> 
        <a href="#" className='underline hover:no-underline  block text-[2vw]'>Instagram</a>
        <a href="#" className='underline hover:no-underline  block text-[2vw]'>Meta</a>

        <a href="#" className='underline hover:no-underline  block text-[2vw]'>X</a>
        <a href="#" className='underline hover:no-underline  block text-[2vw]'>Telegram</a>
      </div>
      </div>
    </div>
  )
